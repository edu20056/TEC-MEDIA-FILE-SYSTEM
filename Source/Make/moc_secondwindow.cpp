...
QT_MOC_LITERAL(3, 25, 12), // "returnToMain"
QT_MOC_LITERAL(4, 38, 12), // "printMessage"
QT_MOC_LITERAL(5, 51, 11), // "openPDFFile"
QT_MOC_LITERAL(6, 63, 14) // "reconstructPDF"

    },
    "SecondWindow\0backToMain\0\0returnToMain\0"
    "printMessage\0openPDFFile\0reconstructPDF"
};
...
void SecondWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->printMessage(); break;
        case 3: _t->openPDFFile(); break;
        case 4: _t->reconstructPDF(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SecondWindow::backToMain)) {
                *result = 0;
                return;
            }
        }
